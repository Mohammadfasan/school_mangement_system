...
import { eventData } from '../assets/images/asserts2.js';
const Event = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-6 pt-20">
      ...
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold text-[#059669] mb-2 mt-25">Welcome to Events</h1>
          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="flex justify-between items-center mb-4 text-sm">
                <span className="text-gray-500">{event.audience}</span>
                {event.days_left > 0 && (
      ...
      {filteredEvents.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-600">There are no {filter} events at the moment.</p>
        </div>
      )}
